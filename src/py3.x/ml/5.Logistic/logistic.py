...
def load_data_set():
    ...
    data_arr = []
    label_arr = []
    f = open('D:/cobs/program/git/AiLearning/src/py3.x/ml/5.Logistic/5.Logistic/TestSet.txt', 'r')
...
def colic_test():
    ...
    :return: 
    """
    f_train = open('D:/cobs/program/git/AiLearning/src/py3.x/ml/5.Logistic/5.Logistic/HorseColicTraining.txt', 'r')
    f_test = open('D:/cobs/program/git/AiLearning/src/py3.x/ml/5.Logistic/5.Logistic/HorseColicTest.txt', 'r')
    training_set = []
    training_labels = []
